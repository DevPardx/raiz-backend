...
export class EmailTemplates {
    ...
    static forgotPasswordEmailTemplate = async (data: RegisterUserEmail, t: TFunction) => {
        const resetUrl = `${env.FRONTEND_URL}/reset-password/${data.token}`;
        return `
                <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                <html dir="ltr" lang="${t("lng")}">
                <head>
                ...
                <body style="background-color:rgb(255,255,255)">
                    ...
                    <tbody>
                        ...
                        <td
                            ...
                            style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0"
                            data-skip-in-text="true">
                            ${t("forgot_password_preview", { ns: "email" })}
                            <div>
                                        ...
                                        <td>
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    <h1
                                                    style="color:rgb(51,51,51);font-size:20px;font-weight:700;margin-bottom:15px">
                                                    ${t("forgot_password_title", { ns: "email" })}
                                                    </h1>
                                                    <p
                                                    style="font-size:14px;line-height:24px;color:rgb(51,51,51);margin-top:24px;margin-bottom:14px;margin-right:0;margin-left:0">
                                                    ${t("forgot_password_body", { ns: "email" })}
                                                    </p>
                                                    <table
                                                    align="center"
                                                    width="100%"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td>
                                                            <a
                                                            href=${resetUrl}
                                                            style="font-size:14px;line-height:24px;background-color:rgb(37,47,61);color:#ffffff;border-radius:4px;padding:10px 40px;width:fit-content;margin:0 auto;font-weight:700;text-align:center;margin-top:25px;margin-bottom:0;margin-left:7px;margin-right:0;text-decoration:none;display:block">
                                                            ${t("forgot_password_verification_code_label", { ns: "email" })}
                                                            </a>
                                                            <p
                                                            style="font-size:14px;line-height:24px;color:rgb(51,51,51);margin:0;text-align:center;margin-top:25px;margin-bottom:0;margin-left:0;margin-right:0">
                                                                ${t("forgot_password_code_validity", { ns: "email" })}
                                                            </p>
                                                        </td>
                                                        </tr>
                                                    </tbody>
